// Generated by test-forge on 2026-05-10T08:48:30.372Z
...
test.describe("Bank Account and Ledger Update", () => {
  ...
  test('completes the main flow successfully', async ({ request }) => {
    ...
    const response2 = await request.get(`${baseUrl}/api/v1/bank-accounts`, { headers: merchantHeaders() });
    expect(response2.status()).toBeLessThan(500);
    const response3 = await request.get(`${baseUrl}/api/v1/ledger`, { headers: merchantHeaders() });
