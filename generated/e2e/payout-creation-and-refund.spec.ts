// Generated by test-forge on 2026-05-10T08:48:30.369Z
...
test.describe("Payout Creation and Refund", () => {
  ...
  test('completes the main flow successfully', async ({ request }) => {
    ...
    const response2 = await request.get(`${baseUrl}/api/v1/payouts/{pk}`, { headers: merchantHeaders() });
    expect(response2.status()).toBeLessThan(500);
    const response3 = await request.get(`${baseUrl}/api/v1/balance`, { headers: merchantHeaders() });
